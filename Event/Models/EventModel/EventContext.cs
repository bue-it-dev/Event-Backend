...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AccommodationId).HasName("PK__Accommod__20C0A5FDA54ECE9F");
            ...
            entity.HasOne(d => d.Event).WithMany(p => p.Accommodations)
                ...
                .HasConstraintName("FK__Accommoda__event__7D63964E");

            entity.HasOne(d => d.RoomType).WithMany(p => p.Accommodations)
                .HasForeignKey(d => d.RoomTypeId)
                .HasConstraintName("FK__Accommoda__roomT__7E57BA87");
        });
        ...
        {
            entity.HasKey(e => e.BuildingId).HasName("PK__Building__979FD1CDD37D3C89");
        ...
        {
            entity.HasKey(e => e.VenueBuildingId).HasName("PK__Building__B0A1D97FA6FA1014");
            ...
            entity.HasOne(d => d.Event).WithMany(p => p.BuildingVenues)
                .HasForeignKey(d => d.EventId)
                .HasConstraintName("FK__BuildingV__event__10766AC2");

            entity.HasOne(d => d.Venue).WithMany(p => p.BuildingVenues)
                .HasForeignKey(d => d.VenueId)
                .HasConstraintName("FK__BuildingV__venue__116A8EFB");
        });
        ...
        modelBuilder.Entity<Event>(entity =>
        {
            ...
            entity.Property(e => e.EventId).HasColumnName("eventId");
            entity.Property(e => e.ApprovingDepName).HasColumnName("approvingDepName");
        ...
        {
            entity.HasKey(e => e.ItcomponentEventId).HasName("PK__ITCompon__0760172701A8E834");
            ...
            entity.HasOne(d => d.Event).WithMany(p => p.ItcomponentEvents)
                .HasForeignKey(d => d.EventId)
                .HasConstraintName("FK__ITCompone__event__18178C8A");

            entity.HasOne(d => d.Itcomponent).WithMany(p => p.ItcomponentEvents)
                .HasForeignKey(d => d.ItcomponentId)
                .HasConstraintName("FK__ITCompone__ITCom__190BB0C3");
        });

        modelBuilder.Entity<ItcomponentLookup>(entity =>
        {
            entity.HasKey(e => e.ItcomponentId).HasName("PK__ITCompon__3213E83FCBE0F1EE");
        ...
        {
            entity.HasKey(e => e.NatureOfEventId).HasName("PK__NatureOf__0D27B156D4CAD27B");
        ...
        {
            entity.HasKey(e => e.RoomTypeId).HasName("PK__roomLook__5E5E0CF3786EE0E9");
        ...
        {
            entity.HasKey(e => e.TransportationId).HasName("PK__Transpor__B8DDDFAD02DC2EF9");
            ...
            entity.HasOne(d => d.Event).WithMany(p => p.Transportations)
                .HasForeignKey(d => d.EventId)
                .HasConstraintName("FK__Transport__event__77AABCF8");

            entity.HasOne(d => d.TransportationType).WithMany(p => p.Transportations)
                .HasForeignKey(d => d.TransportationTypeId)
                .HasConstraintName("FK__Transport__trans__789EE131");
        });

        modelBuilder.Entity<TransportationType>(entity =>
        {
            entity.HasKey(e => e.TransportationTypeId).HasName("PK__Transpor__FA9B322B9E1D2B56");
        ...
        {
            entity.HasKey(e => e.VenueId).HasName("PK__venueLoo__4DDFB71F4DDE5A49");
            ...
            entity.HasOne(d => d.Building).WithMany(p => p.VenueLookups)
                ...
                .HasConstraintName("FK__venueLook__build__0CA5D9DE");

            entity.HasOne(d => d.VenueType).WithMany(p => p.VenueLookups)
                .HasForeignKey(d => d.VenueTypeId)
                .HasConstraintName("FK__venueLook__venue__0D99FE17");
        });

        modelBuilder.Entity<VenueTypeLookup>(entity =>
        {
            entity.HasKey(e => e.VenueTypeId).HasName("PK__venueTyp__4DDFB71FBF1A9481");
